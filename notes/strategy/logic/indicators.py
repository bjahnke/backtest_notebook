...
from notes.strategy.models.indicator import IndicatorCollection
...
class TradingRange(Indicator):
    def __init__(self, high_band_pct, low_band_pct, window=200):
        assert 0 < high_band_pct < 1
        assert 0 < low_band_pct < 1
        super().__init__()
